...
STDLIB_SIGNATURES: dict[str, tuple[list[str], str]] = {
    ...
    'sys_info':      ([],                    'raw'),
    'hash_file':     (['text'],              'raw'),
    # ── BYOVD / Kernel-level functions ───────────────────────────────────────
    'byovd_scan':             ([],                    'raw'),
    'byovd_driver_count':     (['raw'],               'num'),
    'byovd_driver_name':      (['raw', 'num'],        'text'),
    'byovd_driver_path':      (['raw', 'num'],        'text'),
    'byovd_driver_cve':       (['raw', 'num'],        'text'),
    'byovd_driver_risk':      (['raw', 'num'],        'text'),
    'byovd_load':             (['text'],               'flag'),
    'byovd_unload':           ([],                    'nothing'),
    'kernel_read':            (['num', 'num'],         'raw'),
    'kernel_write':           (['num', 'num'],         'nothing'),
    'kernel_base':            ([],                    'num'),
    'kernel_enum_callbacks':  ([],                    'raw'),
    'kernel_callback_count':  (['raw'],               'num'),
    'kernel_callback_addr':   (['raw', 'num'],        'num'),
    'kernel_callback_module': (['raw', 'num'],        'text'),
    'kernel_patch_callback':  (['num'],               'flag'),
