...
declare i8* @"jk_xordecrypt"(i8* %".1", i64 %".2")

@"_jocky_xor_key" = external global i8 0
...
entry:
  ...
  %"decstr" = call i8* @"jk_xordecrypt"(i8* %"strptr", i64 13)
  call void @"report"(i8* %"decstr")
  %"strptr.1" = getelementptr inbounds [12 x i8], [12 x i8]* @".jk_str.1", i32 0, i32 0
  %"decstr.1" = call i8* @"jk_xordecrypt"(i8* %"strptr.1", i64 11)
  %"calltmp" = call i1 @"scan"(i8* %"decstr.1")
  br i1 %"calltmp", label %"then", label %"else"
then:
  %"strptr.2" = getelementptr inbounds [21 x i8], [21 x i8]* @".jk_str.2", i32 0, i32 0
  %"decstr.2" = call i8* @"jk_xordecrypt"(i8* %"strptr.2", i64 20)
  call void @"report"(i8* %"decstr.2")
  br label %"merge"
else:
  %"strptr.3" = getelementptr inbounds [23 x i8], [23 x i8]* @".jk_str.3", i32 0, i32 0
  %"decstr.3" = call i8* @"jk_xordecrypt"(i8* %"strptr.3", i64 22)
  call void @"report"(i8* %"decstr.3")
  br label %"merge"
merge:
  %"strptr.4" = getelementptr inbounds [12 x i8], [12 x i8]* @".jk_str.4", i32 0, i32 0
  %"decstr.4" = call i8* @"jk_xordecrypt"(i8* %"strptr.4", i64 11)
  %"calltmp.1" = call i1 @"scan"(i8* %"decstr.4")
  br i1 %"calltmp.1", label %"then.1", label %"else.1"
then.1:
  %"strptr.5" = getelementptr inbounds [26 x i8], [26 x i8]* @".jk_str.5", i32 0, i32 0
  %"decstr.5" = call i8* @"jk_xordecrypt"(i8* %"strptr.5", i64 25)
  call void @"report"(i8* %"decstr.5")
  br label %"merge.1"
else.1:
  %"strptr.6" = getelementptr inbounds [13 x i8], [13 x i8]* @".jk_str.6", i32 0, i32 0
  %"decstr.6" = call i8* @"jk_xordecrypt"(i8* %"strptr.6", i64 12)
  call void @"report"(i8* %"decstr.6")
  br label %"merge.1"
merge.1:
  %"strptr.7" = getelementptr inbounds [14 x i8], [14 x i8]* @".jk_str.7", i32 0, i32 0
  %"decstr.7" = call i8* @"jk_xordecrypt"(i8* %"strptr.7", i64 13)
  call void @"report"(i8* %"decstr.7")
  ret void
}
